...
pvector<vid_t> run_cc(ChunkGraph* snaph) {
...
void PrintCompStats(ChunkGraph* snaph, const pvector<vid_t> &comp) {
  std::cout << std::endl;
...
bool CCVerifier(ChunkGraph* snaph, const pvector<vid_t> &comp) {
